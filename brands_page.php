      ...
      <ul class="products">
         <?php
            ...
            if (isset($_GET['brand_id']) ) {
              ...
              $brand_sql = "SELECT * FROM products WHERE ProductBrandID='$brand_id'";
              $brand_query = mysqli_query($con, $brand_sql);
              
              $rows = mysqli_num_rows($brand_query);
              if($rows > 0){   
                while ($product = mysqli_fetch_array($brand_query)) {
                    ...
                    echo "<img class='product_image'  src='admin-area/images/$product_image' alt=$product_name><br><br><center>
                            ...
                            <a href='brands_page.php?add_cart=$product_id' class='display_button'>Add to Cart</a>
                                </div>
                            </li>";
